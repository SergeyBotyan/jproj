...
urlpatterns = [
    ...
    path('delete-book-in-order/<int:pk>', DeleteBookInOrder.as_view(), name='delete-book-in-order'),
    ...
    path('adm-edit-order/<int:pk>', OrderAdmEditView.as_view(), name='adm-edit-order'),
